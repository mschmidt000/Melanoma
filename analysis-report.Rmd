...
p2 <- ggplot(subset(obj_integr@meta.data, Mel), aes(x = factor(1), fill = Tsoi_classification)) +
  geom_bar() +
  coord_polar(theta = "y") + 
  theme_void() +
  scale_fill_brewer(palette="Set1") 
...
p1 <- ggplot(subset(obj_integr@meta.data, Mel), aes(x = seurat_clusters, fill = Tsoi_classification)) +
  geom_bar() + 
  theme_minimal() +
  scale_fill_brewer(palette="Set1")  +
  theme(
...
p2 <- ggplot(subset(obj_integr@meta.data, Mel), aes(x = seurat_clusters, fill = Tsoi_classification)) +
  geom_bar(position = "fill") + 
  theme_minimal() +
  scale_fill_brewer(palette="Set1") +
  theme(
