#' Run scrat without seurat preprocessing and cell cycle correction on custom seurat object
#'
#' @param seurat_object
#' @return env
scrat_run_maria <- function(env, seurat_object, only_reporting = FALSE)
{
if(!only_reporting == TRUE){
	...
	env$seuratObject <- seurat_object
